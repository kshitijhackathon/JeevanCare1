...
export class EnhancedLocalMedicalEngine {
  ...
  extractSymptoms(text: string): string[] {
    ...
    const symptomPatterns = {
      ...
      'burning_urination': /\b(burning urination|painful urination|पेशाब में जलन|peshab mein jalan)\b/gi,
      'frequent_urination': /\b(frequent urination|bar bar peshab|बार बार पेशाब)\b/gi,
